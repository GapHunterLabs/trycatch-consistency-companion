...
dependencies {
    ...
    intellijPlatform {
        ...
        // Java PSI (PsiMethodCallExpression.resolveMethod(), PsiTryStatement,
        // PsiCatchSection, method throws-list resolution) is the real
        // mechanism this plugin is built on -- v0.1 is Java-only.
