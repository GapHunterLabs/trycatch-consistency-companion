package dev.gaphunter.trycatchconsistencycompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.trycatchconsistencycompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.trycatchconsistencycompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "Try/Catch Consistency Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34083-try-catch-consistency-companion/reviews"
